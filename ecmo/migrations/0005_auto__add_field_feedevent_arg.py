...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedEvent.arg'
        db.add_column('ecmo_feedevent', 'arg', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedEvent.arg'
        db.delete_column('ecmo_feedevent', 'arg')
