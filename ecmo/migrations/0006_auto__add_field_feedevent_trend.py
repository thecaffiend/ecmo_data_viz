...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedEvent.trend'
        db.add_column('ecmo_feedevent', 'trend', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedEvent.trend'
        db.delete_column('ecmo_feedevent', 'trend')
