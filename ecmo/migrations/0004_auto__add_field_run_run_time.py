...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Run.run_time'
        db.add_column('ecmo_run', 'run_time', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Run.run_time'
        db.delete_column('ecmo_run', 'run_time')
