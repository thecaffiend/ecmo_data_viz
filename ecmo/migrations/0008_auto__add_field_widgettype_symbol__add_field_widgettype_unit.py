...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WidgetType.symbol'
        db.add_column('ecmo_widgettype', 'symbol', self.gf('django.db.models.fields.CharField')(default='P', max_length=3), keep_default=False)

        # Adding field 'WidgetType.unit'
        db.add_column('ecmo_widgettype', 'unit', self.gf('django.db.models.fields.CharField')(default='mmHG', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WidgetType.symbol'
        db.delete_column('ecmo_widgettype', 'symbol')

        # Deleting field 'WidgetType.unit'
        db.delete_column('ecmo_widgettype', 'unit')
